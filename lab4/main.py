...
print("Приближенное решение системы методом Ньютона(Модифицированный):", current_x, current_y)
print("Количество итераций:", num)


"""Test"""
print("\nРезультаты тестового примера системы sin(xy)=x , x^2+y^2=1\n")
def eq_1(x, y):
    return pylab.sin(x*y+0.5) - x
